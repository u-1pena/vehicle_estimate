...
class CustomerServiceTest {
  ...
  class ReadClass {
    ...
    void 指定した車両番号４桁で検索すること() {
      ...
      List<CustomerInformationRequest> actualList = customerService.findInformationByPlateVehicleNumber(
          "1234");

      CustomerInformationRequest actual = actualList.get(0);
    ...
    void 指定した名字や名前でユーザー情報を検索すること() {
      ...
      List<CustomerInformationRequest> actualList = customerService.
    ...
    void 複数の車両情報を持つユーザーを正しく取得できること() {
      ...
      List<CustomerInformationRequest> userInfoList = customerService.findCustomerInformationById(
          2);
      CustomerInformationRequest actual = userInfoList.get(0);
      assertCustomerInformation(actual, expectedCustomer, expectedCustomerAddress,
          expectedVehicles);
    }
    ...
    private void assertCustomerInformation(CustomerInformationRequest actual,

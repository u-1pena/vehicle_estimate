...
import yuichi.car.estimate.management.helper.CustomizedMockMvc;
...
class CustomerControllerTest {
  ...
  class ReadClass {
    ...
    void 指定した名前で顧客検索ができること() throws Exception {
      ...
      customerInformationDto.setCustomer(testHelper.customerMock().get(0));
      customerInformationDto.setCustomerAddress(testHelper.customerAddressMock().get(0));
      customerInformationDto.setVehicles(List.of(testHelper.vehicleMock().get(0)));
      List<CustomerInformationDto> expected = List.of(customerInformationDto);
